            ...
            <div class="col-md-3 col-sm-6">
                <div class="footer-about-us">
                    ...
                    <div class="footer-social">
                        <a href="https://www.facebook.com/caikem1" target="_blank"><i class="fa fa-facebook"></i></a>
                        <a href="https://twitter.com/CostaCaike" target="_blank"><i class="fa fa-twitter"></i></a>
                        <a href="http://instagram.com/kingcaike" target="_blank"><i class="fa fa-instagram"></i></a>
                    </div>
                </div>
            </div>
...
<div class="footer-bottom-area">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <div class="copyright">
                    <p>&copy; 2018 Caike's Store. <a href="http://www.caikestore.com.br" target="_blank">caikestore.com.br</a></p>
                </div>
            </div>
